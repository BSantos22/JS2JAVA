...
/*
	...
	public void arrays1() {
		...
		Map<String, String> programVars = test.test("files/arrays/array1.json", "files/types1.json");
	...
	public void arrays2() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/arrays/array2.json", "files/types1.json");
	...
	public void arrays3() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/arrays/array3.json", "files/types1.json");
	...
	public void arrays4() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/arrays/array4.json", "files/types1.json");
	...
	public void assignments1() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/assignments/asgn1.json", "files/types1.json");
	...
	public void assignments2() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/assignments/asgn2.json", "files/types1.json");
	...
	public void conditions1() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/conditions/cond1.json", "files/types1.json");
	...
	public void conditions2() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/conditions/cond2.json", "files/types1.json");
	...
	public void declarations1() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec1.json", "files/types1.json");
	...
	public void declarations2() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec2.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, d=double}");
	...
	public void declarations3() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec3.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, d=int}");
	...
	public void declarations4() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec4.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, d=double}");
	...
	public void declarations5() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec5.json", "files/types1.json");
	...
	public void declarations6() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec6.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, d=int, e=int}");
	...
	public void declarations7() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec7.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, d=double, e=double}");
	...
	public void declarations8() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/declarations/dec8.json", "files/types1.json");
	...
	public void loops1() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/loops/loop1.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, i=int}");
	...
	public void loops2() {
		JS2Java test = new JS2Java();
		Map<String, String> programVars = test.test("files/loops/loop2.json", "files/types1.json");
		assertEquals(programVars.toString(), "{a=int, b=double, c=double, s=boolean}");
